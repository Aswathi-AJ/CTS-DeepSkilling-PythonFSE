...
def run_setup_and_navigation_demo():
    ...
    options.add_argument('--headless=new')  # Execute browser in headless mode without GUI
    ...
    try:
        ...
        2. Mixing implicit and explicit waits causes unpredictable wait times (e.g. cumulative delays).
        ...
        # STEP 25: Quit browser driver instance
        driver.quit()
