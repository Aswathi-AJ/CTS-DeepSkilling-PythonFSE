...
import pytest
from handson_07.pages.simple_form_page import SimpleFormPage
from handson_07.pages.checkbox_page import CheckboxPage
from handson_07.pages.dropdown_page import DropdownPage
from handson_07.pages.input_form_page import InputFormPage
